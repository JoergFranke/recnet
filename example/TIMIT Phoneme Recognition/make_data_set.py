...
from preprocess.get_phonemes import get_target, get_timit_dict
from preprocess.get_features import get_features
...
drainDir = "data_set/"
#drainDir = "/project/student_projects2/jfranke/workspace/data_set/"
...
train_speaker, valid_speaker = get_speaker_lists(rootDir)
print(train_speaker)
print(train_speaker.__len__())
print(valid_speaker)
print(valid_speaker.__len__())
dic_location = "preprocess/phonemlist"
...
for d in dirlist:
    for dirName, subdirList, fileList in os.walk(rootDir + d + "/"):
...
# test_set_y = []
#
# for dirName, subdirList, fileList in os.walk(rootDir + "TEST/"):
#     print('Found directory: %s' % dirName)
#     temp_name = ""
#     for fname in sorted(fileList):
#         name = fname.split(".")[0]
